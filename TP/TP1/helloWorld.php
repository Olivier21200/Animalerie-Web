    ...
    <div class="container "> 
        <div class="mb-3 mt-3"> 
            ...
            <form action="annee.php" method="post">
                <h3>Saisir l'année</h3> 
                    <label for="numberres" class="form-label">Saisir l'année :</label>
                    <input type="number" name="numberres" class="form-control" id="anne" min=0 max=2500 value=2021 require/>       
        </div>
                    <input type="submit" name="submit" class="btn btn-primary" value="Envoyer votre réponse"/>
            </form>
    </div>
